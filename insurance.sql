...
insert into person (driver_id,name,address) values ('A01','RICHARD', 'SRINIVAS NAGAR'),('A02','PRADEEP', 'RAJAJINAGAR'),('A03','SMITH','ASHOK NAGAR'),('A04','VENU', 'N R COLONY'),('A05','JHON', 'HANUMANTH NAGAR');
select*from person;
